...
if ( ! function_exists( 'lsx_scripts_add_styles' ) ) :
	...
	function lsx_scripts_add_styles() {
		...
		wp_enqueue_style( 'select2', get_template_directory_uri() . '/assets/css/vendor/select2.min.css', array(), LSX_VERSION);
		wp_style_add_data( 'select2', 'rtl', 'replace' );
...
if ( ! function_exists( 'lsx_scripts_add_scripts' ) ) :
	...
	function lsx_scripts_add_scripts() {
		...
		wp_enqueue_script( 'select2', get_template_directory_uri() . '/assets/js/vendor/select2.full.min.js', array( 'jquery' ), LSX_VERSION, true );
		wp_enqueue_script( 'readmore', get_template_directory_uri() . '/assets/js/vendor/readmore.min.js', array( 'jquery' ), LSX_VERSION, true );
