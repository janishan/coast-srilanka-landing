...
<?php if ( of_get_option('contactbox', '1') == '1' ):  ?>
	...
	<div id="contact-box-item" class="contact-container boxrel full-width-image-overlay" style="background-color:<?php echo of_get_option('contactbox-color', '#09A0E7'); ?>; background-image:url('<?php echo of_get_option('contactbox-image', get_template_directory_uri() . '/images/contact.jpg'); ?>');">
		...
		<div class="content-box container">
			...
			<a href="<?php echo of_get_option('contactbox-item-link', 'Inquire Now'); ?>" class="read-more bttn primary-btn">Get In Touch</a>	
		</div>
	</div>
