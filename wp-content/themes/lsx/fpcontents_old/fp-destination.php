...
<?php if ( of_get_option('destinationbox', '1') == '1' ):  ?>
	...
	<div id="destination-box-item" class="destination-container boxrel full-width-image-overlay" style="background-color:<?php echo of_get_option('destinationbox-color', '#09A0E7'); ?>; background-image:url('<?php echo of_get_option('destinationbox-image', get_template_directory_uri() . '/images/assets/minneriya-national-park.jpg'); ?>');">
		...
		<div class="content-box container">
			...
			<a href="<?php echo of_get_option('destinationbox-item-link', 'Inquire Now'); ?>" class="read-more bttn primary-btn">See All Destinations</a>	
		</div>
	</div>
