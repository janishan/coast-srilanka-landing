...
function minimal_lsx_scripts() {
	...
	wp_enqueue_script( 'custom-coast-srilanka-landing', get_stylesheet_directory_uri() . '/assets/js/coast-srilanka-landing.js', array( 'lsx_script' ), MINIMAL_LSX_VER, true );
