...
function lsx_to_included_block() {
	...
	?>
		<section id="included-excluded" class="lsx-to-section <?php lsx_to_collapsible_class( 'tour', false ); ?>">
			<h2 class="lsx-to-section-title lsx-to-collapse-title hidden-lg" <?php lsx_to_collapsible_attributes_not_post( 'collapse-included-excluded' ); ?>><?php esc_html_e( 'Included / Not Included', 'tour-operator' ); ?></h2>
					...
					<div class="row">
						<?php if ( null !== $tour_included ) { ?>
							<div class="<?php echo esc_attr( $class ); ?> included">
								<h4><?php esc_html_e( 'Included', 'tour-operator' ); ?></h4>
                        ...
                        ?>
							<div class="<?php echo esc_attr( $class ); ?> not-included">
								<h4><?php esc_html_e( 'Excluded', 'tour-operator' ); ?></h4>
								<div class="entry-content">
